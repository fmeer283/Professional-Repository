...
public Date(int newMonth, int newDay, int newYear)
{
  ...
  if(newMonth < 1 || newMonth > 12){
      throw new IllegalArgumentException("Not an actual month.");
  }    
  if(newDay < 1 || newDay > 31){
      throw new IllegalArgumentException("Not an actual day.");  
  }
  ...
  if(newMonth == 2 && newDay > 29){
      throw new IllegalArgumentException("February only has 29 days at most.");
  }
 }
